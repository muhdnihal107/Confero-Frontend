  ...
  return (
    <>
      <div className="relative w-full min-h-screen">
        {/* Header is already fixed in its own component */}
        <Header />
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('/src/assets/remote-office-3d-rendering-concept-illustration.jpg')",
          }}
        ></div>

        {/* Content Wrapper - Add padding-top to account for fixed header height */}
        <div className="relative z-10 flex flex-col min-h-screen px-12 pt-20">
          ...
          <div className="mt-32 max-w-lg text-white">
            ...
            <p className="mt-4 text-lg text-gray-300">
              Seamless meetings, effortless conversations. Confero makes
              connecting simple, fast, and engaging.
            </p>
