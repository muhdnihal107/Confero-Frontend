...
const CreateRoom: React.FC = () => {
  ...
  <main className="flex-1 flex items-center justify-center p-4 sm:p-6 md:p-8">
    <div className="w-full max-w-2xl bg-[#00000066] backdrop-blur-md rounded-xl shadow-xl p-6 sm:p-8 transform transition-all duration-500 animate-fade-in">
      <h1 className="text-2xl sm:text-3xl font-bold text-center bg-gradient-to-r from-indigo-400 to-pink-400 bg-clip-text text-transparent mb-6">
        Create a New Room
      </h1>
      ...
      <form onSubmit={handleSubmit} className="grid gap-5 sm:grid-cols-2">
        ...
        <div className="sm:col-span-2">
          ...
          <textarea
            ...
            onChange={handleChange}
            className="w-full p-3 rounded-lg bg-gray-700/50 border border-gray-600 text-white placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none resize-none h-20 transition-all duration-300"
        ...
        <div>
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full p-3 rounded-lg bg-gray-700/50 border border-gray-600 text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all duration-300 appearance-none bg-right bg-no-repeat pr-10"
